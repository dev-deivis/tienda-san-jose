    ...
    return (
      <div className="min-h-screen bg-cream flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <p className="text-gray-400 mb-8 max-w-sm">
          Aún no has agregado ningún artículo. Explora nuestra tienda y encuentra algo especial.
        </p>
        <Link
          href="/"
            ...
            <div className="sticky top-24 bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-col gap-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-400 italic">Calculado en el siguiente paso</span>
                </div>
